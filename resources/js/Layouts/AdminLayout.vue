...
<template>
    ...
    <div x-data="setup()" :class="{ 'dark': isDark }">
        ...
        <div class="fixed w-full flex items-center justify-between h-14 text-white z-10">
            ...
            <img class="w-7 h-7 md:w-10 md:h-10 mr-2 rounded-md overflow-hidden" src="../../image/logo/escudo.png" />
        ...
        <div class="fixed flex flex-col top-14 left-0 w-14 hover:w-64 md:w-64 bg-blue-900 dark:bg-gray-900 h-full text-white transition-all duration-300 border-none z-10 sidebar">
            ...
            <ul class="flex flex-col py-4 space-y-1">
                ...
                <a href="#" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-800 dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6">
                    ...
                    <span class="ml-2 text-sm tracking-wide truncate">Titulares</span>
                    <span class="hidden md:block px-2 py-0.5 ml-auto text-xs font-medium tracking-wide text-blue-500 bg-indigo-50 rounded-full">1200</span>
                </a>
                </li>
                <li>
                <a href="#" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-800 dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6">
            ...
            <p class="mb-14 px-5 py-3 hidden md:block text-center text-xs">Copyright @PasoBlanco</p>
            </div>
        </div>
        <!-- ./Sidebar -->
