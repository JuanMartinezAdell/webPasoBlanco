...
<template>
    <div>
        ...
        <div class="relative min-h-screen bg-gray-100 dark:bg-gray-900">
            ...
            <footer
                class="absolute bottom-0 w-full p-2 bg-white shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800"
            >
                <div
                ...
                <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                    <p
                        class="mt-4 text-lg text-gray-500 dark:text-gray-300 sm:mt-0"
                    >
                        © Copyright Paso Blanco de Huercal-Overa 2022. All
                        Rights Reserved.
                    </p>
                </div>
