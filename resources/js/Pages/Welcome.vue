...
<template>
    <AppLayout title="Welcome">
        <!-- Carousel -->
        <div class="h-screen">
            <div class="relative h-full bg-gray-100 font-sans text-base text-black">
                <div class="h-screen">
            <div class="relative h-full bg-gray-100 font-sans text-base text-black">
                <swiper
                :spaceBetween="30"
        ...
        <div class="container mx-auto px-6 py-6 mt-8 text-center">
            <button class="rounded-lg px-6 pt-4 text-center text-sm font-medium capitalize leading-5 focus:outline-none lg:mx-0 lg:w-auto">
                <img src="../../image/logo/logoPaso.png" alt="logo Paso Blanco" width="300" height="500">
            </button>
        ...
        <div class="mt-12 m-auto -space-y-4 items-center justify-center md:flex md:space-y-0 md:-space-x-4 xl:w-10/12">
            <div class="relative group md:w-6/12 lg:w-7/12">
                ...
                <div class="relative p-6 pt-16 md:p-8 md:pl-12 md:rounded-r-2xl lg:pl-20 lg:p-16">
                    <h3 class="text-3xl text-gray-800 dark:text-white  font-semibold text-center">Cuota</h3>
                    <div>
                        <div class="relative flex justify-around">
                            <div class="flex items-end">
                                <span class="text-8xl text-gray-800 font-bold leading-0">16</span>
                                <div class="pb-2">
                                    <span class="block text-2xl text-gray-700 font-bold">Semestral</span>
                                    <span class="block text-5xl text-blue-500 font-bold">€</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <ul role="list" class="w-max space-y-4 py-6 m-auto text-gray-600">
                        ...
                        <li class="space-x-2">
                            <span class="text-blue-500 font-semibold">&check;</span>
                            <span>Accde en cualquier momento a tus suscripciones y donativos</span>
                        </li>
                    </ul>
                    <PrimaryButton class="block w-full py-3 px-6 text-center">
            ...
            <div class="relative z-10 -mx-4 group md:w-6/12 md:mx-0 lg:w-5/12">
                ...
                <div class="relative p-6 space-y-6 lg:p-8">
                    <h3 class="text-3xl text-gray-800 dark:text-white  font-semibold text-center">Cuota Anual</h3>
                    <div>
                        <div class="relative flex justify-around">
                            <div class="flex items-end">
                                <span class="text-8xl text-gray-800 font-bold leading-0">30</span>
                                <div class="pb-2">
                                    <span class="block text-2xl text-gray-700 font-bold">Anual</span>
                                    <span class="block text-5xl text-blue-500 font-bold">€</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <ul role="list" class="w-max space-y-4 py-6 m-auto text-gray-600">
                        <li class="space-x-2">
                            <span class="text-blue-500 font-semibold">&check;</span>
                            <span>Paga tu cuota de manera anual y despreocupate</span>
                        </li>
                        <li class="space-x-2">
                            <span class="text-blue-500 font-semibold">&check;</span>
                            <span>Accede a todo el contenido web</span>
            ...
            <div class="relative group md:w-6/12 lg:w-7/12">
                <div aria-hidden="true" class="absolute top-0 w-full h-full rounded-2xl bg-white shadow-2xl transition duration-500 group-hover:scale-105"></div>
                <div class="relative p-6 pt-16 md:p-8 md:pl-12 md:rounded-r-2xl lg:pl-20 lg:p-16">
                    <h3 class="text-3xl text-gray-800 dark:text-white  font-semibold text-center">Cuota Mensual</h3>
                    <div>
                        <div class="relative flex justify-around">
                            <div class="flex items-end">
                                <span class="text-8xl text-gray-800 font-bold leading-0">30</span>
                                <div class="pb-2">
                                    <span class="block text-2xl text-gray-700 font-bold">Mensual</span>
                                    <span class="block text-5xl text-blue-500 font-bold">€</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <ul role="list" class="w-max space-y-4 py-6 m-auto text-gray-600">
                        ...
                        <li class="space-x-2">
                            <span class="text-blue-500 font-semibold">&check;</span>
                            <span>Deten tu subscripcion o reiniciala en cualquier momento</span>
                        </li>
                        <li class="space-x-2">
                            <span class="text-blue-500 font-semibold">&check;</span>
                            <span>Registra todas tus cuotas y donativos</span>
                        </li>
                    </ul>
                    <PrimaryButton class="block w-full py-3 px-6 text-center">
                            Paga tu cuota
    ...
    <div class="container mx-auto px-6 py-10">
        ...
        <div>
            <div class="relative">
            <img class="h-64 w-full rounded-lg object-cover object-center lg:h-80" src="../../image/blog/cultoParoquia.jpg" alt="" />

            <div class="absolute bottom-0 flex bg-white p-3 dark:bg-gray-900">
                <img class="h-10 w-10 rounded-full object-cover object-center" src="../../image/logo/logo.jpg" alt="" />

                <div class="mx-4">
                <h1 class="text-sm text-gray-700 dark:text-gray-200">Parroquia</h1>
                <p class="text-sm text-gray-500 dark:text-gray-400">Huercal-Overa</p>
                </div>
            </div>
            </div>

            <h1 class="mt-6 text-xl font-semibold text-gray-800 dark:text-white">Primer día del Triduo a Nuestro Padre Jesús de Pasión Cautivo</h1>

            <hr class="my-6 w-32 text-blue-500" />

            <p class="text-sm text-gray-500 dark:text-gray-400">Mañana jueves, comienza el triduo  a Nuestro Padre Jesús de Pasión Cautivo. Será jueves,  viernes y sábado a las 19,30...</p>

            <a href="#" class="mt-4 inline-block text-blue-500 underline hover:text-blue-400">Leer más</a>
        </div>

        <div>
            <div class="relative">
            <img class="h-64 w-full rounded-lg object-cover object-center lg:h-80" src="../../image/blog/premio.jpg" alt="" />

            <div class="absolute bottom-0 flex bg-white p-3 dark:bg-gray-900">
                <img class="h-10 w-10 rounded-full object-cover object-center" src="../../image/logo/logo.jpg" alt="" />

                <div class="mx-4">
                <h1 class="text-sm text-gray-700 dark:text-gray-200">Noticias</h1>
                <p class="text-sm text-gray-500 dark:text-gray-400">La voz de Almería</p>
                </div>
            </div>
            </div>

            <h1 class="mt-6 text-xl font-semibold text-gray-800 dark:text-white">Premio Semana Santa</h1>

            <hr class="my-6 w-32 text-blue-500" />

            <p class="text-sm text-gray-500 dark:text-gray-400">Ayer 21 de julio, la Semana Santa de Huércal-Overa fue distinguida con el Premio Sociedad en la XIII edición de los Premios Levante organizado por La Voz de Almería, Cadena Ser y los 40...</p>
        ...
        <div>
            <div class="relative">
            <img class="h-64 w-full rounded-lg object-cover object-center lg:h-80" src="../../image/blog/parroquia.png" alt="" />
            ...
            <h1 class="mt-6 text-xl font-semibold text-gray-800 dark:text-white">Las hermanitas de los Ancianos Desamparados</h1>

            <hr class="my-6 w-32 text-blue-500" />

            <p class="text-sm text-gray-500 dark:text-gray-400">Las hermanitas de los Ancianos Desamparados de Huercal-Overa piden alimentos previas fiestas navideñas...</p>

            <a href="#" class="mt-4 inline-block text-blue-500 underline hover:text-blue-400">Lee más</a>
        </div>
        </div>
        ...
        <section class="bg-white dark:bg-gray-900">
            <div class="container mx-auto px-6 py-10">
                <h1 class="text-center text-3xl font-semibold capitalize text-gray-800 dark:text-white lg:text-4xl">Fotos y Videos</h1>

                <p class="mt-4 text-center text-gray-500 dark:text-gray-300">Accede al repositorio de fotos y videos del Paso Blanco de Huercal-overa</p>
    ...
    <div class="container mx-auto -mt-72 px-6 py-10 sm:-mt-80 md:-mt-96">
        ...
        <div class="flex flex-col items-center rounded-xl border p-4 dark:border-gray-700 sm:p-6">
            <img class="aspect-square w-full rounded-xl object-cover" src="../../image/carousel/ViregenAngustias.jpg" alt="" />
        ...
        <div class="flex flex-col items-center rounded-xl border p-4 dark:border-gray-700 sm:p-6">
            <img class="aspect-square w-full rounded-xl object-cover" src="../../image/carousel/SanJuanBnadera.jpg" alt="" />
        ...
        <div class="flex flex-col items-center rounded-xl border p-4 dark:border-gray-700 sm:p-6">
            <img class="aspect-square w-full rounded-xl object-cover" src="../../image/carousel/caida.jpg" alt="" />
        ...
        <div class="flex flex-col items-center rounded-xl border p-4 dark:border-gray-700 sm:p-6">
            <img class="aspect-square w-full rounded-xl object-cover" src="../../image/carousel/cautivo.jpg" alt="" />
        ...
        <div class="flex flex-col items-center rounded-xl border p-4 dark:border-gray-700 sm:p-6">
            <img class="aspect-square w-full rounded-xl object-cover" src="../../image/carousel/cristoSangre.jpg" alt="" />
        ...
        <div class="flex flex-col items-center rounded-xl border p-4 dark:border-gray-700 sm:p-6">
            <img class="aspect-square w-full rounded-xl object-cover" src="../../image/carousel/cropped-logo2.jpg" alt="" />
        ...
        <div class="container mx-auto px-6 py-10">
            ...
            <div class="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 xl:mt-12 xl:grid-cols-3 xl:gap-12">
                <div v-for="product in products" :key="product.id" class="flex justify-center">
                    <div class="rounded-lg shadow-lg bg-white max-w-sm">
                        <div class="bg-white pounded shadow-xl" :image="product.image" :name="product.name" :description="product.description" :price="product.price">
                            <div class="h-56 bg-cover bg-center p-4" style="background-image: url({{ product.image }}) ">
                                <span class="bg-gray-100 text-blue-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded-full dark:bg-gray-700 dark:text-gray-300">{{ product.price }}€</span>
                            </div>
                            <div class="px-6 py-4">
                                <h1 class="mt-4 text-2xl font-semibold capitalize text-gray-900 dark:text-white">{{ product.name }}</h1>
                                <p class="text-gray-700 text-base mb-4">
                                    {{ product.description }}
                                </p>
