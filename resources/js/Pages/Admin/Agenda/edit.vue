...
const updateUsers = () => {
    form.put(route("diary.update", form.id));
};
</script>
    ...
    <AdminLayout title="Diary">
        <div class="container mx-auto px-6 py-6 mt-8 text-center">
            <div class="container mx-auto px-6 py-20">
                <FormSection @submitted="updateUsers" class="pb-16">
                    <template #title> Edita Los Usuarios Hermandad </template>

                    <template #description>
                        Edita los usuarios para la agenda de la Hermandad del
                        Paso.
                    </template>
                    <template #form>
                        <!-- Title -->
