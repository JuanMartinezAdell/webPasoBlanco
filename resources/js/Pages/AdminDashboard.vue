...
//import BarChart from "@/NewComponents/BarChart.vue";
...
onMounted(async () => {
    // Aquí es donde obtendrías los datos reales desde tu backend.
    // Estoy simulando una solicitud de red con un retraso.
