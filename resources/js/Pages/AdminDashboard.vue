...
<template>
    <AdminLayout title="Dashboard">
        ...
        <div class="md:col-span-2 xl:col-span-3">
            <h1 class="text-3xl font-semibold text-center p-4">
                Control Cuotas Miembros
            </h1>
        </div>
        <div class="px-6 pt-6 2xl:container">
                    ...
                    >
                        ...
                        <div>
                            ...
                            <span class="block text-center text-gray-500"
                                >Comparado con el mes pasado 250€</span
                            >
                        </div>
                    ...
                    >
                        ...
                        <div class="my-8">
                            ...
                            <span class="text-gray-500"
                                >Comparadop con el mes pasado 12</span
                            >
                        </div>
                        <svg
                            class="w-full"
                ...
                <div>
                    ...
                    >
                        ...
                        <div class="mt-6">
                            ...
                            <span class="block text-center text-gray-500"
                                >Comparado con el mes pasado 5</span
                            >
                        </div>
                        <table class="mt-6 -mb-2 w-full text-gray-600">
                            <tbody>
            ...
            <div class="md:col-span-2 xl:col-span-3">
                <h1 class="text-3xl font-semibold text-center p-4">
                    Control de Gastos y Beneficios
                </h1>
            </div>
                    ...
                    <div class="md:col-span-2 lg:col-span-1">
                        ...
                        >
                            ...
                            <div>
                                ...
                                <span class="block text-center text-gray-500"
                                    >Comparado con el año pasado 1000€</span
                                >
                            </div>
                            <table class="w-full text-gray-600">
                                <tbody>
                    ...
                    <div>
                        ...
                        >
                            ...
                            <div class="my-8">
                                ...
                                <span class="text-gray-500"
                                    >Comparadop con el año pasdo 233€</span
                                >
                            </div>
                            <svg
                                class="w-full"
            ...
            <div class="flex justify-between mb-1 pt-4">
                <span
                    class="text-lg font-medium text-yellow-700 dark:text-white"
                    >Cuotas pendiente Pago</span
                >
                <span
                    class="text-lg font-medium text-yellow-700 dark:text-white"
                    >75%</span
            ...
            <div class="flex justify-between mb-1 pt-4">
                <span
                    class="text-base font-medium text-green-700 dark:text-white"
                    >Gastos</span
                >
            ...
            <div class="flex justify-between mb-1 pt-4">
                <span class="text-base font-medium text-red-700 dark:text-white"
                    >Beneficos</span
                >
                ...
                <ul>
                    ...
                    <li class="mt-2">
                        ...
                        >
                            ...
                            <span class="inline-flex pl-2"
                                >Section: Recent Activities</span
                            >
                        </a>
                    </li>
                </ul>
